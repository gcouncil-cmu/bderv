#
# This software is copyrighted material (C) Shai Revzen 2009-2013
#
...
from numpy import \
    ...
    zeros,concatenate,tensordot,vstack,diff,c_,r_
...
class odeDP5( Integro ):
  ...
  def refine( self, evtFun, *args ):
    ...
    self.yOut[-1] = concatenate((y.copy(), self.aux(t,y,args).copy()))
